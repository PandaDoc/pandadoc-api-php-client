...
/**
 * PricingTableRequestRows Class Doc Comment
 *
 * @category Class
 * @package  PandaDoc\Client
 * @author   OpenAPI Generator team
 ...
 */
class PricingTableRequestRows implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PricingTableRequest_rows';
     ...
     * Sets options
     *
     * @param \PandaDoc\Client\Model\PricingTableRequestRowOptions|null $options options
     *
     * @return self
     */
