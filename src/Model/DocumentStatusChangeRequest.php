...
/**
 * DocumentStatusChangeRequest Class Doc Comment
 *
 * @category Class
 * @package  PandaDoc\Client
 * @author   OpenAPI Generator team
 ...
 */
class DocumentStatusChangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentStatusChangeRequest';
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'note' => 'setNote',
        'notifyRecipients' => 'setNotifyRecipients'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['notifyRecipients'] = $data['notifyRecipients'] ?? null;
    }
     ...
     * Sets note
     *
     * @param string|null $note Provide “private notes” regarding the manual status change.
     *
     * @return self
     */
    ...
    /**
     * Sets notifyRecipients
     *
     * @param bool|null $notifyRecipients Send a notification email about the status change to all recipients.
     *
     * @return self
     */
