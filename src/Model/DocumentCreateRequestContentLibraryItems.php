...
/**
 * DocumentCreateRequestContentLibraryItems Class Doc Comment
 *
 * @category Class
 * @package  PandaDoc\Client
 * @author   OpenAPI Generator team
 ...
 */
class DocumentCreateRequestContentLibraryItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentCreateRequest_content_library_items';
     ...
     * Sets id
     *
     * @param string $id Content library item id
     *
     * @return self
     */
     ...
     * Sets recipients
     *
     * @param \PandaDoc\Client\Model\DocumentCreateByTemplateRequestRecipients[]|null $recipients recipients
     *
     * @return self
     */
