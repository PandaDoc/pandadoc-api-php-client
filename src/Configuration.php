...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.pandadoc.com';
     ...
     * @var string
     */
    protected $userAgent = 'pandadoc_php_client/5.7.1';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 5.7.1' . PHP_EOL;
        $report .= '    SDK Package Version: 5.7.1' . PHP_EOL;
