...
class DocumentsApi
{
    ...
    /**
     * Operation documentMoveToFolder
     *
     * Document move to folder
     *
     * @param  string $id Specify document ID. (required)
     * @param  string $folderId Specify folder ID. (required)
     *
     * @throws \PandaDoc\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function documentMoveToFolder($id, $folderId)
    {
        $this->documentMoveToFolderWithHttpInfo($id, $folderId);
    }

    /**
     * Operation documentMoveToFolderWithHttpInfo
     *
     * Document move to folder
     *
     * @param  string $id Specify document ID. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function documentMoveToFolderWithHttpInfo($id, $folderId)
    {
        $request = $this->documentMoveToFolderRequest($id, $folderId);
    ...
    /**
     * Operation documentMoveToFolderAsync
     *
     * Document move to folder
     *
     * @param  string $id Specify document ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentMoveToFolderAsync($id, $folderId)
    {
        return $this->documentMoveToFolderAsyncWithHttpInfo($id, $folderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation documentMoveToFolderAsyncWithHttpInfo
     *
     * Document move to folder
     *
     * @param  string $id Specify document ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentMoveToFolderAsyncWithHttpInfo($id, $folderId)
    {
        $returnType = '';
        $request = $this->documentMoveToFolderRequest($id, $folderId);
    ...
    /**
     * Create request for operation 'documentMoveToFolder'
     *
     * @param  string $id Specify document ID. (required)
     * @param  string $folderId Specify folder ID. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function documentMoveToFolderRequest($id, $folderId)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling documentMoveToFolder'
            );
        }
        // verify the required parameter 'folderId' is set
        if ($folderId === null || (is_array($folderId) && count($folderId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folderId when calling documentMoveToFolder'
            );
        }

        $resourcePath = '/public/v1/documents/{id}/move-to-folder/{folder_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $id Document ID (required)
     * @param  \PandaDoc\Client\Model\DocumentUpdateRequest $documentUpdateRequest documentUpdateRequest (required)
     *
     * @throws \PandaDoc\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateDocument($id, $documentUpdateRequest)
    {
        $this->updateDocumentWithHttpInfo($id, $documentUpdateRequest);
    }
     ...
     *
     * @param  string $id Document ID (required)
     * @param  \PandaDoc\Client\Model\DocumentUpdateRequest $documentUpdateRequest (required)
     *
     * @throws \PandaDoc\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDocumentWithHttpInfo($id, $documentUpdateRequest)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDocumentAsync($id, $documentUpdateRequest)
    {
        return $this->updateDocumentAsyncWithHttpInfo($id, $documentUpdateRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDocumentRequest($id, $documentUpdateRequest)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($documentUpdateRequest === null || (is_array($documentUpdateRequest) && count($documentUpdateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $documentUpdateRequest when calling updateDocument'
            );
        }
        ...
        // for model (json/xml)
        if (isset($documentUpdateRequest)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($documentUpdateRequest));
            } else {
                $httpBody = $documentUpdateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
